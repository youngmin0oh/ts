...
from experiments.quantile_calibrator import QuantileCalibrator, pinball_loss, soft_coverage_penalty
...
class Exp_Decom(Exp_Basic):
    ...
    def train_quantile_calibrator(self, setting, taus,
                              ...
                              max_epochs=20,patience=5, device="cuda"):
