...
from layers.PeriodAttention import PeriodAttention, PeriodAttentionLayer
import numpy as np
            ...
            [
                EncoderLayer(
                    PeriodAttentionLayer(
                        PeriodAttention(None, attention_dropout=configs.dropout,
