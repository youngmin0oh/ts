...
import random
import numpy as np
from experiments.exp_online_xy_combined_norm import Exp_Combined_Norm
...
if __name__ == '__main__':
    ...
    parser = argparse.ArgumentParser(description='Unified Adapter Experiment (Add, Mul, Affine) - w/ Norm')
    ...
    if args.is_training:
        for ii in range(args.itr):
            ...
            # Initialize Experiment with Norm
            exp = Exp_Combined_Norm(args, adapter_mode='add')
            ...
            for mode in modes_to_run:
                print(f"\n=====================================================")
                print(f"Running Adapter Mode (Norm): {mode}")
                print(f"=====================================================")
        ...
        exp = Exp_Combined_Norm(args, adapter_mode='add') # Default
